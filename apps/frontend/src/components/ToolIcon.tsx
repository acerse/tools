...
const icons: Record<string, ReactNode> = {
  ...
  'line-sorter': (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      ...
      <polyline points="20 15 20 21 16 18" />
    </svg>
  ),
  'duplicate-remover': (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      <rect x="8" y="2" width="13" height="13" rx="2" />
      <path d="M5 8H4a2 2 0 00-2 2v9a2 2 0 002 2h9a2 2 0 002-2v-1" />
...
export function ToolIcon({ id, className = 'h-4 w-4' }: { id: string; className?: string }) {
  const icon = icons[id]
  if (!icon) return null
